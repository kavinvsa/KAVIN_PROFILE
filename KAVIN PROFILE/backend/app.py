...
try:
    from backend.resume_knowledge import RESUME_DOCUMENTS, corpus_texts
...
@app.post("/api/chat", response_model=ChatResponse, summary="Ask Me Chatbot (API prefix)")
